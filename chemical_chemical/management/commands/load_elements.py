...
class Command(BaseCommand):
    help = 'Load elements from CSV files into the database'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Load elements dataset and update group and period
        ...
        self.stdout.write(self.style.SUCCESS('Successfully loaded elements'))
